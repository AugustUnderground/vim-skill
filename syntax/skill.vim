...
syn match skillKeywords     "(define\>"hs=s+1
syn match skillKeywords     "\<define("he=e-1
...
syn match skillKeywords     "(letseq\>"hs=s+1
syn match skillKeywords     "\<letseq("he=e-1
syn match skillKeywords     "(letrec\>"hs=s+1
syn match skillKeywords     "\<letrec("he=e-1
...
hi def link skillCommen			Comment
